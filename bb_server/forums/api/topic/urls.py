...
topic_token_list = TopicListView.as_view('top')
...
site.add_url_rule('/token/<token>/<int:page>', view_func=topic_token_list)
...
site.add_url_rule('/comment/replies/<int:replyId>', view_func=reply)
