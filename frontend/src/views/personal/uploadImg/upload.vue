...
<div class="vue-image-crop-upload" v-show="value">
    <div class="vicp-wrap">
        ...
        <div class="vicp-step1" v-show="step == 1">
            <div class="vicp-drop-area left" @dragleave="preventDefault" @dragover="preventDefault" @dragenter="preventDefault" @click="handleClick" @drop="handleChange">
...
<script>
"use strict";
import language from "../uploadImg/js/language.js";
import mimes from "../uploadImg/js/mimes.js";
import data2blob from "../uploadImg/js/data2blob.js";
import effectRipple from "../uploadImg/js/effectRipple.js";
...
export default {
  ...
  methods: {
    ...
    prepareUpload() {
      ...
      this.$emit("cropSuccess", createImgUrl, field);
    ...
    upload() {
      ...
      new Promise(function(resolve, reject) {
        ...
        function(resData) {
          if (that.value) {
            that.loading = 2;
            that.$emit("cropUploadSuccess", resData, field);
          }
        },
        // 上传失败
        function(sts) {
          if (that.value) {
            ...
            that.$emit("cropUploadFail", sts, field);
          }
        }
      );
    }
