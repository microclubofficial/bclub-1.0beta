    ...
    <div class="center-wrap">
      ...
      <form class="form-horizontal password-form">
        ...
        <div class="clearfix button-box margin-top">
          ...
          <button type="button" class=" forphone btnm  btn-confirm" v-bind:disabled="!setPwd.OldPassword" @click='setPwdFun' data-target="#myModal" data-toggle="">{{$t('button.confirm')}}
          </button>
