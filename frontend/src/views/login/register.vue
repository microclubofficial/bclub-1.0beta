            ...
            <div class="col-sm-9">
              <div class="input-group">
                <span class="input-group-addon" style="padding:0;border-right:none;">
                  <img ref="captcha" src="http://172.16.5.67:8000/api/captcha" alt="验证码" width="90" height="20" @click="changVcode">
                </span>
...
export default {
  ...
  methods: {
    ...
    submitForm () {
      // 验证
      var unamereg = /^[a-zA-Z0-9_\u4e00-\u9fa5]{4,16}$/
      if (!unamereg.test(this.userForm.username)) {
        this.unamePrompt = '用户名长度在4-16位之间'
        return
